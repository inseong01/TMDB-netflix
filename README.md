...
1. 프로젝트 구조 ㅡ [functionMap](/md/functionMap.md)

2. 첫번째 페이지 ㅡ [firstPage](/md/firstPage.md)

3. 두번째 페이지 ㅡ [secondPage](/md/secondPage.md)
...
- 6.1.  
  로딩개선, 정보창 리뉴얼(제목, 장르, 평가), 선택 계정 프로필 사진 연동
...
- ## 6.5.
  ...
  - 로딩화면
    ...
    - 커서 클릭 방지  
      : setTimeout 함수에 profiles 배열을 포함시켜서 disabled = true/false 처리 : 사용자가 클릭 인식하기 위해 CSS cursor 속성 변화
